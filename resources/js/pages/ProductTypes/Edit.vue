...
import { type ProductTypeEditProps } from '@/types';
...
const submit = () => {
    form.put(route('product-types.update', props.productType.id), {
        onSuccess: () => {
            toast.success('Typ produktu został pomyślnie zaktualizowany.');
        },
        onError: (errors) => {
